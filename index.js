...
const sushi = createMenuItem('Sushi', 8, 'Lunch/Dinner')
const spaghetti = createMenuItem('Spaghetti', 12, 'Dinner')
console.log(pizza);
console.log(sushi);
...
// reviews.push({name: "Jess", rating: 4, feedback: "I really enjoyed the trivia night"})
// console.log(reviews);
...
function getLastReview(array) {
  ...
  let name = lastReview.name;
  let rating = lastReview.rating;
  let feedback = lastReview.feedback;
  return `${name} gave the restaurant a ${rating} star review, and their feedback was: ${feedback}`;
} 
